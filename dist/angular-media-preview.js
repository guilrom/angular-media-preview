/**
* Package: angular-media-preview - v0.0.2
* Description: create a preview for each media file given in input
* Last build: 2016-11-15
* @author guilrom
* @source codekraft-studio
* @license ISC
*/
...
.directive('mediaPreview', function ($log, $document) {
  ...
  var directive = {
    restrict: 'E',
    scope: { model: '=?' },
    template:   '<input type="file" ng-hide="model" accept="image/*,video/*,audio/*" ng-model="model" />' +
